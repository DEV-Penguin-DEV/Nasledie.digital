...
const editPositionSuccesfulTemplate = () => (`
<div class="modal-container">
  <div class="modal edit-position__save-window">
    ...
    <p class="edit-position__save-window-title">Сохранить внесенные изменения?</p>
    <p class="edit-position__save-window-text">В случае отмены внесенные изменения не сохранятся</p>
    <div class="edit-position__save-window-buttons">
      <div
        ...
        Отменить</div>
      <div class="edit-position__save-window-button button button--green modal__succesful-button">Сохранить</div>
    </div>
  </div>
</div>
`);

export default class EditPositionSuccesfulView extends AbstractView {
  constructor() {
    super();
  }

  get template() {
    return editPositionSuccesfulTemplate();
  }
}
