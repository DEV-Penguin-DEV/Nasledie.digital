  ...
  <nav class="circles-header__navigation navigation">
    <div class="navigation__container">
      ...
      <form class="circles-header__filers filters filters--editing">
        ...
        <button class="filters--editing__button button--icon button button--icon">
    ...
    <div class="navigation__container">
      <button class="circles-header__cansel button button--white button button--cansel button button--white--icon navigation__item">
      ...
      <button class="circles-header__save button button--green navigation__item">
        Сохранить
      </button>
    </div>
  </nav>
